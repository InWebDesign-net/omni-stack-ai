...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      ...
      // Demo creator avatars and the remaining stock thumbnails still reference
      // this host. Narrowed from `**.unsplash.com`: only `images.unsplash.com`
      // is actually used, and the wildcard also covered their upload endpoints.
