...
export const ACCENTS: Record<ContentAccent, AccentClasses> = {
  indigo: {
    ...
    toggleActive: 'bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 font-bold',
    tagIncluded: 'bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 border-indigo-500/40 hover:bg-indigo-500/30',
    tagHover: 'hover:border-indigo-500/40',
    iconPlus: 'text-indigo-600 dark:text-indigo-400',
  ...
  teal: {
    ...
    badge: 'bg-teal-500/15 border-teal-500/30 text-teal-700 dark:text-teal-300',
    toggleActive: 'bg-teal-500/20 text-teal-700 dark:text-teal-300 font-bold',
    tagIncluded: 'bg-teal-500/20 text-teal-700 dark:text-teal-300 border-teal-500/40 hover:bg-teal-500/30',
    tagHover: 'hover:border-teal-500/40',
    iconPlus: 'text-teal-600 dark:text-teal-400',
  ...
  purple: {
    ...
    toggleActive: 'bg-purple-500/20 text-purple-700 dark:text-purple-300 font-bold',
    tagIncluded: 'bg-purple-500/20 text-purple-700 dark:text-purple-300 border-purple-500/40 hover:bg-purple-500/30',
    tagHover: 'hover:border-purple-500/40',
    iconPlus: 'text-purple-600 dark:text-purple-400',
