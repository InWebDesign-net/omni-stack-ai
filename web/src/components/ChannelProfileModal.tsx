  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-[#0d1528] border border-white/10 rounded-3xl p-6 shadow-2xl flex flex-col gap-5 z-50 animate-scaleIn font-sans">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 text-[#9ba4bf] hover:text-white rounded-xl hover:bg-white/5 transition-all"
        >
          <X className="h-5 w-5" />
        </button>
        ...
        <div className="flex items-center gap-4">
          <div className="relative shrink-0">
            ...
            <img
              ...
              className="relative h-16 w-16 rounded-full object-cover border-2 border-white/20 shadow-xl"
            />
          </div>
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 truncate">
              <h3 className="text-lg font-extrabold text-white truncate">{selectedChannel.username}</h3>
        ...
        {/* Action Controls */}
        <div className="flex items-center justify-between pt-2 border-t border-white/6 flex-wrap gap-2.5">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 bg-[#44e2cd] text-[#003731] hover:bg-[#3bcbb8] shadow-lg shadow-[#44e2cd]/20 active:scale-95 cursor-pointer"
            >
            ...
            {canSendDM && (
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs shadow-lg shadow-indigo-600/20 flex items-center gap-1.5 transition-all active:scale-95 cursor-pointer"
              >
