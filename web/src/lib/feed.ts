...
export const FALLBACK_FEED_ITEMS: FeedItem[] = [
  // ─── SHORTS ──────────────────────────────────────────────────────────────
  {
    ...
    thumbnailUrl: '/demo-media/photo-1555066931-4365d14bab8c.jpg',
  ...
  },
  {
    ...
    thumbnailUrl: '/demo-media/photo-1544551763-46a013bb70d5.jpg',
  ...
  },
  {
    ...
    thumbnailUrl: '/demo-media/photo-1612874742237-6526221588e3.jpg',
    tags: ['Kochen', 'Rezepte'],
    viewsCount: 89400,
    likesCount: 7890,
    ...
    author: {
      ...
      handle: '@demogourmet',
      avatarUrl: '/demo-media/photo-1517841905240-472988babdf9.jpg',
  ...
  },
  {
    ...
    thumbnailUrl: '/demo-media/photo-1514888286974-6c03e2ca1dba.jpg',
...
- **REST-API Anbindung:** Integration in Strapi 5 und Next.js App Router.`,
    mediaType: 'pdf',
    mediaUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
    thumbnailUrl: '/demo-media/photo-1618005182384-a83a8bd57fbe.jpg',
  ...
  },
  {
    ...
    mediaType: 'pdf',
    mediaUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
    thumbnailUrl: '/demo-media/photo-1526374965328-7f61d4dc18c5.jpg',
...
4. In Frischhaltefolie gewickelt 30 Minuten im Kühlschrank ruhen lassen.`,
    mediaType: 'article',
    mediaUrl: '',
    thumbnailUrl: '/demo-media/photo-1551183053-bf91a1d81141.jpg',
    tags: ['Kochen', 'Rezepte'],
    viewsCount: 15400,
    likesCount: 1420,
  ...
  },
  {
    ...
    mediaType: 'article',
    mediaUrl: '',
    thumbnailUrl: '/demo-media/photo-1460925895917-afdab827c52f.jpg',
...
4. **PM2 Production Management:** Zuverlässiger 24/7-Betrieb von Next.js und Strapi auf Linux-Servern.`,
    ...
    thumbnailUrl: '/demo-media/photo-1550745165-9bc0b252726f.jpg',
  ...
  },
  {
    ...
    mediaType: 'video',
    mediaUrl: 'https://www.w3schools.com/html/mov_bbb.mp4',
    thumbnailUrl: '/demo-media/photo-1517694712202-14dd9538aa97.jpg',
