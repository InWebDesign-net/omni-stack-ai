    ...
    <div className="min-h-screen bg-base text-primary flex flex-col font-['Hanken_Grotesk',sans-serif]">
      ...
      <main className="flex-1 max-w-content w-full mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 space-y-4 sm:space-y-8">
        ...
        {isLoading ? (
          ...
          <div className="bg-rose-500/10 border border-rose-500/30 rounded-2xl p-6 sm:p-8 text-center space-y-4">
                  ...
                  <div className="pt-2.5 flex-1 flex flex-col justify-between gap-1.5">
                    ...
                    <div className="flex items-center justify-between text-[11px] text-slate-400">
                      <button
                        ...
                        className="flex items-center gap-1.5 hover:opacity-80 transition-opacity min-w-0 text-left cursor-pointer z-10"
                      >
