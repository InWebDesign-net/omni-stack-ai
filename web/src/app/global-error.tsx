...
export default function GlobalError({
  ...
  return (
    <html lang="de" className="dark bg-[#080e1e]">
      <body className="bg-[#080e1e] text-white flex items-center justify-center min-h-screen p-6 font-sans">
        <div className="max-w-lg w-full bg-[#0d1528] border border-rose-500/30 rounded-3xl p-8 shadow-2xl space-y-6">
          ...
          <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 text-xs font-mono text-rose-300 break-words max-h-48 overflow-y-auto">
