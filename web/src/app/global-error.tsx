...
export default function GlobalError({
  ...
  return (
    <html lang="de" className="dark bg-canvas">
      <body className="bg-canvas text-primary flex items-center justify-center min-h-screen p-6 font-sans">
        <div className="max-w-lg w-full bg-surface border border-rose-500/30 rounded-3xl p-8 shadow-2xl space-y-6">
          ...
          <div className="p-4 rounded-2xl bg-canvas border border-subtle text-xs font-mono text-rose-300 break-words max-h-48 overflow-y-auto">
